    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                ...
                <!--REGISTER NEW-->
                <Dialog v-model:visible="personalDialog" header="Personal Detalle" :modal="true" class="p-fluid" :style="{ width: '50rem' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">                    <div class="field">
